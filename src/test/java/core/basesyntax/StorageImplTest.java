...
public class StorageImplTest {
    ...
    public void checkSizeIsNonStatic() {
        Storage<Integer, String> firstInstance = new Storage.StorageImpl<>();
        ...
        Storage<Integer, String> secondInstances = new Storage.StorageImpl<>();
    ...
    public void addElementsToStorage() {
        Storage<Integer, String> storage = new Storage.StorageImpl<>();
    ...
    public void addCustomElementsToStorage() {
        Storage<Integer, Cat> storage = new Storage.StorageImpl<>();
    ...
    public void getElementWhenKeyIsObject() {
        Storage<Cat, String> storage = new Storage.StorageImpl<>();
        String elementOne = "Element 1";
        String elementTwo = "Element 2";
        String elementTree = "Element 3";
        Cat firstCat = new Cat("Myrchyk", "white");
